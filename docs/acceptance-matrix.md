...
| F7 | Previous/current/malformed/future metadata domains | [Metadata matrix](../internal/store/metadata_test.go), [live server-domain checks](../internal/remote/domain_test.go), [transaction backup-domain guards](../internal/store/transaction_domain_test.go), old unbound lock-record cases. | Partial: version checks exist; actual prior/current domain transformations and safe older-binary CRUD policy are not fully proved. |
